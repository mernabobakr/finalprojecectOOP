...
public class BasicOval implements MyShape{
    ...
    public BasicOval(int x1, int y1, int x2, int y2,Color color) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public void draw(Graphics g) {
        ...
        g.drawOval(getUpperLeftX(), getUpperLeftY(), getWidth(), getHeight()); //draws a regular rectangle
